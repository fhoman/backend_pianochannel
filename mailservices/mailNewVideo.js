...
function mailNewVideo(user,video) {
console.log(user)
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                      <td>
                        <p>Dear ${name},</p>
                        <p>
                        I have uploaded the video ${video.snippet.title}<br><br>

                         <img src=${video.snippet.thumbnails.medium.url}>
                         <br><br>

                        Go to your profile page and check out your new video</p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td><a href=${URL}>Go to your profile page</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                  <td class="content-block">
                    <span class="apple-link">Pianolessen Amsterdam</span>
                    
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="https://pianolessenamsterdam.nl">Pianolessen Amsterdam</a>.
                  </td>
                </tr>
              </tbody></table>
            </div>
